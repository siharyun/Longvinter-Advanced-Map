         ...
         static textPreview := ObjBindMethod(Vis2.core.ux.process, "textPreview")
            ...
            if (GetKeyState("Escape", "P")) {
               ...
               else
               {
                  ...
                  Vis2.obj.subtitle.render("선택중...", Vis2.obj.style2_back, Vis2.obj.style2_text)
               }
            }
            else {
         ...
         class process {
            ...
            static selectImage := ObjBindMethod(Vis2.core.ux.process, "selectImage")
               ...
               if !(Vis2.obj.unlock.1 ~= "^Vis2.core.ux.process.selectImage" || Vis2.obj.unlock.2 ~= "^Vis2.core.ux.process.selectImage")
                  SetTimer, % selectImage, -10
               ;변경점
               if (coordLocX = "" && coordLocY = "")
                  MouseGetPos, coordLocX, coordLocY
               return
            }
            ...
            static textPreview := ObjBindMethod(Vis2.core.ux.process, "textPreview")
               ...
               if (coordLocW = "" && coordLocH = "") {
                  MouseGetPos, coordLocW, coordLocH
                  ;MsgBox, 0, info, X:%coordLocX% Y:%coordLocY% W:%coordLocW% H:%coordLocH%
                  ;Sleep 1000
                  ;MouseMove, %coordLocW%, %coordLocH%, ,
                  F8finish()
               }
